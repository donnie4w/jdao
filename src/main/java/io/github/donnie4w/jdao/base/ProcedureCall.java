...
public class ProcedureCall {
	...
	public ProcedureCall(Connection conn, String sql, Params... params) throws JException {
		this.sql = sql;
		this.params = params;
		parseTypes();
		call_(conn);
	...
	public ProcedureCall(JdaoHandler jdao, String sql, Params... params) throws JException {
		this.sql = sql;
		this.params = params;
		parseTypes();
		call(jdao);
	...
	public ProcedureCall(DataSource ds, String sql, Params... params) throws JException {
		this.sql = sql;
		this.params = params;
		parseTypes();
	...
	public ProcedureCall(String sql, Params... params) throws JException {
		this.sql = sql;
		this.params = params;
		parseTypes();
	...
	final void call(JdaoHandler jdao) throws JException {
		Connection con = null;
		try {
	...
	final void call_(Connection conn) throws JException {
