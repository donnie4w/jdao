...
public class ActionTest4 {
	...
	public void call1() throws Exception {
		// call proc_test2()
		new ProcedureCall(JdaoHandlerFactory.getDBHandler4spring(),"proc_test2");
	}
	...
	public void call2() throws Exception {
		// call proc_test(?,?,?)
		ProcedureCall pc = new ProcedureCall(JdaoHandlerFactory.getDBHandler4spring(),
				           "proc_test",Params.IN(30),Params.OUT(Type.VARCHAR),
